...
const FeatureDetail = () => {
  ...
  if (!feature) {
    return (
      <div className="min-h-screen flex flex-col bg-background">
        <SEO title="Feature not found — Warden Network" description="The feature you're looking for doesn't exist." path="/features" />
        <Navbar />
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO
        title={`${feature.title} — Warden Network Features`}
