...
import { z } from "zod";
import { ArrowLeft, FileCode, Loader2, Upload, X } from "lucide-react";
        ...
        <Card className="p-6 space-y-5">
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) => setF({ ...f, long_description: e.target.value })}
              maxLength={8000}
              placeholder="Features, install steps, commands, permissions…"
            />
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-3">
            <div>
              ...
              <Input
                value={f.skript_version}
                onChange={(e) => setF({ ...f, skript_version: e.target.value })}
                placeholder="2.9"
              />
            </div>
            <div>
              ...
              <Input
                value={f.mc_version}
                onChange={(e) => setF({ ...f, mc_version: e.target.value })}
          ...
          <div>
            ...
            <Textarea
              rows={3}
              value={f.screenshots}
              onChange={(e) => setF({ ...f, screenshots: e.target.value })}
          ...
          <div className="flex items-center justify-between rounded-md border border-border p-3">
            <div>
              ...
              <div className="text-xs text-muted-foreground">
                Off = saved as draft, visible only to you.
              </div>
            </div>
            <Switch
              checked={f.published}
          ...
          <div className="flex justify-end gap-2 pt-2">
            <Button variant="outline" asChild>
              <Link to="/discover/skripts">Cancel</Link>
            </Button>
