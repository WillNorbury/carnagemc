...
export default function Install() {
  ...
  return (
    <>
      <Helmet>
        <title>Install XyloMC — Add to Home Screen</title>
        <meta name="description" content="Install the XyloMC web app to your phone or desktop for a fullscreen, app-like experience." />
        <link rel="canonical" href="/install" />
      </Helmet>

      <main className="container max-w-2xl py-10 px-4">
        <div className="flex flex-col items-center text-center mb-8">
          <img src={logo} alt="XyloMC logo" className="h-20 w-20 mb-4" />
          <h1 className="font-display text-3xl md:text-4xl font-bold tracking-wider">
            Install <span className="text-gradient">XyloMC</span>
          </h1>
          <p className="text-muted-foreground mt-2">
            Get the full XyloMC experience as an installable web app — fullscreen, fast, and right on your home screen.
          </p>
        </div>
        ...
        {installed ? (
          <Card className="border-primary/40">
            <CardContent className="flex items-center gap-3 py-6">
              ...
              <p className="font-medium">XyloMC is installed. You're running the app version!</p>
            </CardContent>
          </Card>
        ) : (
          <>
                ...
                <CardContent className="flex flex-col sm:flex-row items-center justify-between gap-4 py-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm text-muted-foreground">Add XyloMC to your device now.</p>
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-3 text-sm">
                  ...
                  <Step n={3} icon={<CheckCircle2 className="h-4 w-4" />}>
                    Tap <b>Add</b> — XyloMC will appear on your home screen.
                  </Step>
                </CardContent>
              </Card>
