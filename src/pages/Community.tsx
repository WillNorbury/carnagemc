...
const Community = () => {
  ...
  useEffect(() => {
    document.title = "Community — HavocSMP";
      ...
      <main className="flex-1">
        ...
        <section className="relative pt-28 pb-16 overflow-hidden">
          ...
          <div className="container relative text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">Join thousands of legends building, fighting, and forging history on HavocSMP.</p>
          </div>
        </section>
          ...
          <section className="grid md:grid-cols-3 gap-5">
            ...
            <Card className="p-7 flex flex-col justify-center border-primary/30">
              ...
              <Button asChild className="glow w-full">
                <a href="https://discord.havocsmp.net" target="_blank" rel="noreferrer">
