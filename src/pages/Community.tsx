...
const Community = () => {
  ...
  useEffect(() => {
    document.title = "Community — CarnageMC";
      ...
      <main className="flex-1">
        ...
        <section className="relative pt-28 pb-16 overflow-hidden">
          ...
          <div className="container relative text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">Join thousands of legends building, fighting, and forging history on CarnageMC.</p>
          </div>
        </section>
