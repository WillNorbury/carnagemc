...
const Vote = () => {
  ...
  useEffect(() => {
    document.title = "Vote — Warden Network";
    try {
      ...
      <main className="flex-1">
        ...
        <section className="relative pt-28 pb-14 overflow-hidden">
          ...
          <div className="container relative text-center">
            ...
            <h1 className="font-display text-4xl md:text-6xl font-black mb-3">Vote for <span className="text-gradient">Warden Network</span></h1>
