...
import { Wrench, X, UserPlus, Search } from "lucide-react";
...
const DEFAULT: Config = {
  ...
  message: "Warden Network is undergoing scheduled maintenance. Check back soon!",
  allowed_roles: [],
  allowed_user_ids: [],
};
...
// Legacy /admin/maintenance route — redirect to the tabbed admin UI.
const AdminMaintenance = () => <Navigate to="/admin?tab=maintenance" replace />;
