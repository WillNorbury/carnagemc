...
// Renders a 1200x630 PNG with a title, optional subtitle/eyebrow and the Warden Network brand.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const title = (url.searchParams.get("title") || "Warden Network").slice(0, 200);
